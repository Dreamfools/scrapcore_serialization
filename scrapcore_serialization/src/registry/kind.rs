...
use crate::registry::inline::InlineOrId;
use crate::registry::SerializationRegistry;

/// Trait for registry to provide kinds for supported types
...
impl<Registry: ItemKindProvider<T>, T> ItemKindProvider<InlineOrId<T>> for Registry {
    fn kind() -> Self::ItemKind {
        <Registry as ItemKindProvider<T>>::kind()
    }
}
